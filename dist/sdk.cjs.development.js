...
})(exports.Rounding || (exports.Rounding = {})); // export const FACTORY_ADDRESS = '0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f' // 以太坊网络


var FACTORY_ADDRESS = '0x74aC9080Bf16D3603F6aef02dBe1Ce8806049BAd';
var INIT_CODE_HASH = '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f'; // export const ROUTER_ADDRESS = '0x85af5505cA753045CfCF4ab98C0bC8d4F828B1B3' // 以太坊网络
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input)) ?  invariant(false, 'INPUT')  : void 0; // invariant(
    ...
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output)) ?  invariant(false, 'OUTPUT')  : void 0; // const path: Token[] = [input instanceof Token ? input : WETH[pairs[0].chainId]]
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    if (tradeType === exports.TradeType.EXACT_INPUT) {
      !currencyEquals(amount.currency, route.input) ?  invariant(false, 'INPUT')  : void 0; // amounts[0] = wrappedAmount(amount, route.chainId)
      ...
      !currencyEquals(amount.currency, route.output) ?  invariant(false, 'OUTPUT')  : void 0; // amounts[amounts.length - 1] = wrappedAmount(amount, route.chainId)
  ...
  currentPairs, originalAmountIn, bestTrades) {
    ...
    !(chainId !== undefined) ?  invariant(false, 'CHAIN_ID')  : void 0; // let amountIn = wrappedAmount(currencyAmountIn, chainId)
  ...
  currentPairs, originalAmountOut, bestTrades) {
    ...
    !(chainId !== undefined) ?  invariant(false, 'CHAIN_ID')  : void 0; // const amountOut = wrappedAmount(currencyAmountOut, chainId)
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    var time = ['0', '18446744073709551615', '0', '18446744073709551615']; // FSN
